...
- `tests/fixtures/gdpr_data_samples_main/generated_format_challenges.json` preserves generated high-difficulty multilingual format cases, including UTF-16 text, XML, RTF, newline-delimited JSON, OpenDocument, EML email, ZIP archive, image OCR, and PDF OCR cases with OCR-degraded label separators, without mutating Drive originals.
