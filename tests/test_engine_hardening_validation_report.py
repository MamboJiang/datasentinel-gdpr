...
class EngineHardeningValidationReportTests(unittest.TestCase):
    def test_validation_report_tracks_current_deployment_evidence(self) -> None:
        ...
        self.assertTrue(deployment["appRelease"].endswith("20260601061735-risk-taxonomy"))
        self.assertTrue(deployment["frontendRelease"].endswith("20260601055633-supported-format-alignment"))
        self.assertEqual(deployment["remoteBackendTests"]["testCount"], 171)
        ...
        self.assertEqual(report["localValidation"]["frontendTests"]["testCount"], 79)
