...
- `core_negative_cases.json` contains synthetic no-sensitive-info enterprise text, CSV, JSON, Markdown, and log cases used to measure false-positive behavior for budgets, SKUs, release configs, procurement text, and operations numbers.
