...
3. Regenerate `raw_corpus_manifest.json`, `corpus_scan_report.json`, `engine_hardening_validation_report.json`, `core_engine_performance_report.json`, `core_engine_performance_report_agent_us.json`, and `live_drive_scan_report_agent_us.json` when final-hardening validation evidence changes.
4. Run `python3 -m unittest tests.test_gdpr_data_samples_corpus tests.test_core_engine_detection tests.test_generated_format_challenges tests.test_core_engine_performance_report tests.test_live_drive_scan_report`.
