...
`core_negative_cases.json` is the synthetic clean-corpus companion. It covers enterprise budgets, product SKUs, release configs, Markdown budget tables, CSV inventory rows, Chinese and German procurement text, and operations logs that should not create GDPR-sensitive findings.
