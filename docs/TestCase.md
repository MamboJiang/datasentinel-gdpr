...
| CORE-003B | Scan no-sensitive-info enterprise samples | Clean budget, SKU, release-config, Markdown table, CSV inventory, procurement, and operations-log samples produce zero GDPR-sensitive signal types while still participating in quality metrics. |
