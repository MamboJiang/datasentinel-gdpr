...
| CORE-003A | Generate deterministic core-engine quality report | The quality report evaluates multilingual and generated-format oracle cases, records type-level precision, recall, F1, false-positive type counts, and false-negative type counts, and does not persist raw source text or raw detected values. |
