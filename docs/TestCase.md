...
| CORE-011 | Scan structured text-like files | CSV, TSV, LOG, XML, JSON, JSONL/NDJSON, HTML/HTM, and UTF-16 text-like files with multilingual labels produce redacted findings, easy difficulty counts, and source-data evidence anchors without leaking raw values. |
