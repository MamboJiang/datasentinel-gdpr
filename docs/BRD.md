...
- Recognize common text, email, archive, PDF text-layer, bounded local PDF OCR, image OCR, Office document, and OpenDocument sources through deterministic processing before any optional AI assistance.
